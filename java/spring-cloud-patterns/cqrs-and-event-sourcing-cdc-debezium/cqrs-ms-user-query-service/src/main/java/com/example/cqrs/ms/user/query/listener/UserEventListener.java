package com.example.cqrs.ms.user.query.listener;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.example.cqrs.ms.user.query.entity.UserEntity;
import com.example.cqrs.ms.user.query.repo.UserRepository;
        ...
        if (StringUtils.hasText(message)) {
            try {
                ...
                if (payload.get("before") == null && payload.get("after") != null) {
                    ...
                    LOGGER.info("Saved user: {}", userToBeCreated);
                    ...
                    LOGGER.info("Deleted user: {}", userToBeDeleted);
                }
            } catch (Exception e) {
