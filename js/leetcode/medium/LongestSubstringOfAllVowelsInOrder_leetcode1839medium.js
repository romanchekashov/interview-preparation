...
function longestBeautifulSubstring2(word) {
    let count = 0, res = 0;
    let used = new Set();
...
function longestBeautifulSubstring3(word) {
    let count = 0, res = 0;
    let uniqueChars = 1;
    let prev = word.charAt(0);
...
function longestBeautifulSubstring4(word) {
    let cnt = 1;
    let len = 1;
    let max_len = 0;
...
const solutions = [
    ...
    longestBeautifulSubstring2,
    longestBeautifulSubstring3,
    longestBeautifulSubstring4
];
