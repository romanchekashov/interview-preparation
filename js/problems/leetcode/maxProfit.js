...
var maxProfit = function (prices) {
    ...
    function calcMax(startIdx) {
        if (startIdx === prices.length - 1) return 0;
 ...
 * We can observe that the sum A+B+CA+B+C is equal to the difference DD corresponding to the difference between the heights of the consecutive peak and valley.
 *
 * Complexity Analysis
...
const solutions = [maxProfit, maxProfit2];

solutions.forEach((solution) => {
    console.log(`Run tests for: ${solution.name}`);
    measurePerformance(() => {
        assert(7, solution([7, 1, 5, 3, 6, 4]));
        assert(4, solution([1, 2, 3, 4, 5]));
        assert(0, solution([7, 6, 4, 3, 1]));
        assert(
            1697678,
            solution([
                397,
